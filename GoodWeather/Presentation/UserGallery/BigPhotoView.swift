...
class BigPhotoView: UIView {
    ...
    private func setViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            leftView.trailingAnchor.constraint(equalTo: visibleView.leadingAnchor, constant: -8),
            ...
            rightView.leadingAnchor.constraint(equalTo: visibleView.trailingAnchor, constant: 8),
            
            nameLabel.bottomAnchor.constraint(equalTo: visibleView.topAnchor, constant: -20),
            nameLabel.centerXAnchor.constraint(equalTo: visibleView.centerXAnchor),
            nameLabel.heightAnchor.constraint(equalToConstant: 40),
            nameLabel.widthAnchor.constraint(equalToConstant: 370),
            
            decriptionLabel.topAnchor.constraint(equalTo: visibleView.bottomAnchor, constant: 20),
            decriptionLabel.centerXAnchor.constraint(equalTo: visibleView.centerXAnchor),
    ...
    // Уменьшение и прозрачность фото при прокручивании
    private func firstTransformAnimate() {
        UIView.animate(
            ...
            animations: { [unowned self] in
                ...
                if visibleView.transform == scale {
                    visibleView.alpha = 0.5
                    rightView.alpha = 0.3
                    leftView.alpha = 0.3
                    decriptionLabel.alpha = 0.2
                    nameLabel.alpha = 0.2
    ...
    //возвращение фото в первоначальный скейл и плотность изображения
